...
| Webhook signing secret (`PADDLE_WEBHOOK_SECRET`) | `<rotated — obtain from Paddle Sandbox dashboard → Notifications>` |
...
PADDLE_WEBHOOK_SECRET=<rotated — keep in Render only, never commit>
