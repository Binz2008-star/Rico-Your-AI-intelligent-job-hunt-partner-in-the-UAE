...
from src.response_intelligence import ResponseIntelligenceEngine, create_response_intelligence_engine
...
class FeedbackLoopSystem:
    ...
    def __init__(
        ...
        self._response_engine = response_engine or create_response_intelligence_engine(decision_engine)
...
def run_learning_cycle(decision_engine: JobDecisionEngine) -> Dict[str, Any]:
...
def should_run_learning_cycle(decision_engine: JobDecisionEngine) -> bool:
