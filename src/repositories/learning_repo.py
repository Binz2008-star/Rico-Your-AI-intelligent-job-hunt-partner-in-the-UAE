...
def record_learning_signal(
    ...
    """Module-level convenience wrapper for LearningRepository.record_signal."""
...
def infer_signals_from_job_action(
    ...
    """Module-level convenience wrapper for LearningRepository.infer_signals_from_job_action."""
