...
class TestPricingValues:
    def test_rico_monthly_price_is_21_50_by_default(self, monkeypatch):
        monkeypatch.delenv("RICO_MONTHLY_PRICE_USD", raising=False)
        ...
        assert len(plans) == 1
        assert plans[0]["price_monthly"] == 21.5
