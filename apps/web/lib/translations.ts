...
export const translations = {
  en: {
    ...
    keywordsPlaceholder: "e.g. ESG, HSE, Sustainability",
    keywordTagHint: "Press Enter or , to add a keyword",
    ...
    onboardingPdfOnly: "PDF only · max 10 MB",
  ...
  ar: {
    ...
    keywordsPlaceholder: "مثل: HSE، ESG، الاستدامة",
    keywordTagHint: "اضغط Enter أو , للإضافة",
    ...
    onboardingPdfOnly: "PDF فقط · حد أقصى 10 ميغابايت",
