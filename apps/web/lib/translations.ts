...
export const translations = {
  en: {
    ...
    themeLight: "Light",
    themeSystem: "System",
    themeHint: "Your choice is saved and applied across all your devices.",
    settingsAppearanceIntro: "Customize how Rico looks and feels.",
    dark: "Dark",
    light: "Light",
    system: "System",
    language: "Language",
  ...
  ar: {
    ...
    themeLight: "فاتح",
    themeSystem: "النظام",
    themeHint: "يُحفظ اختيارك ويُطبّق على جميع أجهزتك.",
    settingsAppearanceIntro: "خصّص مظهر ريكو وشعوره.",
    dark: "داكن",
    light: "فاتح",
    system: "النظام",
    language: "اللغة",
