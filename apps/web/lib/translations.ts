...
export const translations = {
  en: {
    ...
    cmdWelcomeBack: "Welcome back. What would you like to work on today?",
    cmdWelcomePublic: "Hi, I'm Rico — your AI job-hunt partner in the UAE. How can I help?",
  ...
  ar: {
    ...
    cmdWelcomeBack: "مرحبًا بعودتك. بماذا تريد أن أساعدك اليوم؟",
    cmdWelcomePublic: "مرحبًا، أنا ريكو — شريكك الذكي في البحث عن عمل في الإمارات. كيف يمكنني مساعدتك؟",
