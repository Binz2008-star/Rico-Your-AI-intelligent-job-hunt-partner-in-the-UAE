...
export const translations = {
    en: {
        ...
        landingFitScore: "fit",
        landingOpportunityEngineSubtitle: "Live matching without the job-board noise",
        landingTelegramAlertsSubtitle: "Signals arrive when timing changes",
        landingControlSubtitle: "Autonomous intelligence, approval-first action",
    ...
    ar: {
        ...
        landingFitScore: "ملاءمة",
        landingOpportunityEngineSubtitle: "مطابقة حية بدون ضوضاء لوحات الوظائف",
        landingTelegramAlertsSubtitle: "تصل الإشارات عند تغيير التوقيت",
        landingControlSubtitle: "ذكاء مستقل، إجراءات بالموافقة أولاً",
        landingPerMonth: "/شهر",
