...
export const translations = {
  en: {
    ...
    cmdWelcomeCvReady: "Your CV is ready — I've built your profile. Select a next step or ask me anything.",
  ...
  ar: {
    ...
    cmdWelcomeCvReady: "سيرتك الذاتية جاهزة — بنيت ملفك الشخصي. اختر خطوتك التالية أو اسألني أي شيء.",
