...
// "X is not a function". Any component in the tree that loads a font
// (LandingPageV2, WorkspaceShell via atelier-kit/fonts, onboarding) would crash
// at import. Stub every named font export with a factory returning the shape
// next/font produces (className / variable / style).
