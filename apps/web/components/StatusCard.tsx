...
export function StatusCard({ title, badge, badgeLabel, value, href, children, className }: StatusCardProps) {
        ...
        <>
            ...
            {value && (
                <div className="relative z-10 flex items-end gap-2">
                    ...
                    <span className="mb-1.5 h-2 w-2 rounded-full bg-cyan shadow-[0_0_22px_rgba(0,229,255,0.7)] animate-pulse" />
                </div>
            )}
    ...
    const cardClass = cn(
        ...
        isInteractive && "group hover:border-cyan/30 hover:shadow-[0_24px_70px_rgba(0,0,0,0.28),0_0_0_1px_rgba(0,229,255,0.06)] hover:scale-[1.02] hover:-translate-y-1",
