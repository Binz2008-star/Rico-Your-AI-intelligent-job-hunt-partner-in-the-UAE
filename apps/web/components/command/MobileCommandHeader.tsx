    ...
    return (
        <>
            ...
            <div
                ...
                aria-modal="true"
                className={`fixed top-0 start-0 rtl:start-auto rtl:end-0 z-50 h-full w-72 max-w-[85vw] flex flex-col shadow-[4px_0_40px_rgba(0,0,0,0.5)] transition-transform duration-300 ease-out overflow-hidden ${
