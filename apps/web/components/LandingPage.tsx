        ...
        <MotionConfig reducedMotion="user">
            ...
            <div dir={isAr ? "rtl" : "ltr"} className="command-dark-lock relative min-h-screen overflow-x-hidden bg-background text-white">
                <div className="fixed inset-0 pointer-events-none z-0">
                    ...
                    <motion.div
                        aria-hidden="true"
                        animate={{ opacity: [0.25, 0.45, 0.25], scale: [1.01, 1, 1.01] }}
                ...
                <main className="relative z-10">
                    {/* Hero */}
                    <section className="mx-auto grid min-h-[calc(100vh-73px)] max-w-7xl items-center gap-8 px-5 py-12 md:grid-cols-[1fr_0.88fr] md:gap-12 md:py-16 md:px-10 lg:px-16">
                        <motion.div
                        ...
                        >
                            ...
                            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                                ...
                                <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.98 }}>
                                    <Link
                                        href="/signup"
                                        className="inline-flex w-full items-center justify-center rounded-full border border-white/10 bg-white/[0.04] px-8 py-4 text-base font-semibold text-white backdrop-blur-xl transition-colors hover:bg-white/[0.08] sm:w-auto"
                                    >
                                        {t.ctaStartFree}
                                    </Link>
                                </motion.div>
