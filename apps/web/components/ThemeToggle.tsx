...
export function ThemeToggle({ className = "" }: { className?: string }) {
    ...
    return (
        <button
            ...
            className={`flex h-9 w-9 items-center justify-center rounded-lg border border-border-soft bg-surface/60 text-text-secondary transition-colors hover:border-border-strong hover:text-text-primary rico-focus-strong ${className}`}
        >
            {isDark ? (
                // Sun — tap to go light
