...
const variants: Record<ButtonVariant, string> = {
    primary:
        "bg-gold text-[#0a0a1a] shadow-[0_4px_16px_rgba(245,166,35,0.28)] hover:bg-gold-hover hover:-translate-y-px hover:scale-105 active:scale-95",
    ghost:
    ...
    (
        ...
        <button
            ...
            className={cn(
                ...
                "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/50 focus-visible:ring-offset-1 focus-visible:ring-offset-surface",
                variants[variant],
                sizes[size],
                className
            )}
