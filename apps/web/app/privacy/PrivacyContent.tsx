...
/**
 * /privacy — Atelier V2 light-first island (PR C2).
 *
 * Same pattern as the /terms pilot (C1): a self-contained light-first Atelier
 * island under the otherwise-dark app, styled entirely through the shared,
 * scoped `.atelier` token layer in app/_atelier/atelier-tokens.css. Language
 * still comes from the existing global useLanguage(); dir/lang are mirrored onto
 * the `.atelier` wrapper for self-contained RTL. No localStorage, no
 * ThemeContext, no global default change. All EN/AR legal copy preserved
 * verbatim. SEO metadata lives in ./page.tsx (unchanged).
 */
