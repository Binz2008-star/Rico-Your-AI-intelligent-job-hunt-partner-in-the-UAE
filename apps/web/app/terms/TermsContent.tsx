        ...
        <article className="atl-doc-panel">
          ...
          <div className="atl-doc-body">
            ...
            <section>
              ...
              <p>
                {isAr
                  ? "تتطلب بعض الميزات اشتراكاً مدفوعاً. تُعالج المدفوعات عبر Paddle. تتجدد الاشتراكات تلقائياً ما لم يتم إلغاؤها. يمكنك الإلغاء في أي وقت بالتواصل مع الدعم. لا استرداد للأشهر الجزئية ما لم يقتضِ ذلك القانون."
                  : "Some features require a paid subscription. Payments are processed through Paddle. Subscriptions auto-renew unless cancelled. You may cancel at any time by contacting support. No refunds for partial months unless required by law."}
              </p>
            </section>
